...
      // Muestra el mensaje de error de Firebase (si tiene código y mensaje) o un mensaje genérico
      if (err.code && err.message) {
         error.value = err.message;
         // Si el código es 'internal' y no hay un mensaje más específico, podría ser el error CORS o similar
