...
.form-container {
  ...
  border: 2px solid #eee9e7; /* Borde */
  position: relative; /* Necesario para posicionar el botón de regreso absolutamente DENTRO */
  /* Si el botón está FUERA de form-container pero dentro de page-content, position: relative iría en page-content */
}
...
.back-to-list-btn {
    ...
    padding: 8px 15px; /* Padding más pequeño que los botones del formulario */
    background-color: #bebebe; /* Un color neutro (gris) */
...
.back-to-list-btn:hover {
    background-color: #ccc; /* Gris más oscuro al pasar el ratón */
